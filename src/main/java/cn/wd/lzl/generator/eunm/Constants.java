package cn.wd.lzl.generator.eunm;
...
public class Constants {
    ...
    public static final String CURRENT_DEPT_NAME = "current_dept_name";
    ...
    public final static String ACCESS_MFA_TEMP_TOKEN = "access_mfa_temp_token_";

    public final static String ACCESS_USERID = "access_userid_";

    public static final String RESOURCE_PREFIX = "/profile";

    public final static String ACCESS_USERIDS = "access_userids_";

    public final static String EMAIL_LOGIN_VERIFY = "email_login_verify_";

    public final static String EMAIL_CHANGE_VERIFY = "email_change_verify_";
